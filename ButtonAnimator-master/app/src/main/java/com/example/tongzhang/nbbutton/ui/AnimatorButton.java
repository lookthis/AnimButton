...
//        ValueAnimator valueAnimator = ValueAnimator.ofInt(width, heigh);
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                int lOffset = width-value;
                int rOffset = width +value;
...
//        ObjectAnimator objectAnimator = ObjectAnimator.ofFloat(backDrawable, "cornerRadius", heigh / 2, 120);
        ObjectAnimator objectAnimator = ObjectAnimator.ofFloat(backDrawable, "cornerRadius", heigh / 2, (heigh / 2) + dip2px(10));
